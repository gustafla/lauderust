    ...
    let state = use_state(|| (vec![], vec![], HashMap::new(), Duration::ZERO));
    {
        ...
        use_effect_once(move || {
            ...
            wasm_bindgen_futures::spawn_local(async move {
                ...
                let mut user_locations = Request::get("https://hackathlon.nitorio.us/coordinates")
                    .send()
                    .await
                    .unwrap()
                ...
                let mut ticker = IntervalStream::new(interval.as_millis() as u32);
